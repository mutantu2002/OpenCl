...
public class LinkedClusterablesOpenCl4D implements Serializable{
	...
	public LinkedClusterablesOpenCl4D(ListClusterable clusterables) {
		...
		program = new Program(Program.readResource("/opencl/ElasticSmoothie4D.c"),params);
		...
		memVw = new MemoryDouble(program);
	...
	public void stepV(){
		stepV.run(filters.clusterables.size(), filters.clusterables.size());
		program.finish();
	}
