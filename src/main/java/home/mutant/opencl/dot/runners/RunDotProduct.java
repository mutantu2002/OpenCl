...
public class RunDotProduct {
 	...
 	public static void main(String[] args) throws Exception {
		...
		ObtainFiltersDot  of = new ObtainFiltersDot(MnistDatabase.trainImages.subList(0, 256*39)).
				setDimFilterX(10).setDimFilterY(10).setNoClusters(noClusters).build();
		of.cluster();
		...
		TransformImagesMapDot1D ti = new TransformImagesMapDot1D(MnistDatabase.trainImages.subList(0, 256*39), of.getClusterImages(), 1);
		ti.transform();
