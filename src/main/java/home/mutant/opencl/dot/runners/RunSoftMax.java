...
public class RunSoftMax {
 	...
 	public static void main(String[] args) throws Exception {
		...
		SoftMaxShort sm = new SoftMaxShort(MnistDatabase.trainImages.subList(0, 256*234), 
				MnistDatabase.trainLabels.subList(0, 256*234), 10).setNoIterations(100).
				setTestImages(MnistDatabase.testImages.subList(0, 256*39), MnistDatabase.testLabels.subList(0, 256*39)) .build();
		sm.cluster();
